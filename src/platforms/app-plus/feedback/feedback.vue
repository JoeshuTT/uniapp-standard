<template>
    <view class="page">
        ...
        <view class="feedback-body">
            <textarea v-model="sendDate.content" placeholder="请详细描述你的问题和意见..." class="feedback-textare" />
        </view>
        <view class="feedback-title">
            ...
            <view class="uni-uploader">
                ...
                <view class="uni-uploader-body">
                    <view class="uni-uploader__files">
                        ...
                        <view v-show="imageList.length < 5" class="uni-uploader__input-box">
                            <view class="uni-uploader__input" @tap="chooseImg" />
                        </view>
                    </view>
                </view>
            </view>
        ...
        <view class="feedback-body">
            <input v-model="sendDate.contact" class="feedback-input" placeholder="(选填,方便我们联系你 )" />
        </view>
        <view class="feedback-title feedback-star-view">
            <text>应用评分</text>
            <view class="feedback-star-view">
                <uni-rate v-model="sendDate.score" color="#bbb" />
            </view>
        </view>
